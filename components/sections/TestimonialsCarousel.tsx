      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-[#1C1C1C] tracking-tight">
            Loved by Ambitious <GradientText>Founders Across India</GradientText>
          </h2>
          <p className="text-base text-[#6B7280]">
            Hear how our web engineering & ROI pipelines accelerated revenue growth for Tier 1 Indian companies.
          </p>
        </div>
